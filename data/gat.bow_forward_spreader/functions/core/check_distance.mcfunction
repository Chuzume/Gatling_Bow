...
#
# @within function gat.bow_forward_spreader:core/randomizer
...
# while ((x^2+y^2) > r^2) randomizer
    ...
    execute if score $Temp ForwardSpreader > $Radius^2 ForwardSpreader run function gat.bow_forward_spreader:core/randomizer
# リセット

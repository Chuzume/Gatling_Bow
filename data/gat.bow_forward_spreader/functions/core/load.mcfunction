#> gat.bow_forward_spreader:core/load
#
# 初期化処理
#
...
# init random number generator
    execute unless data storage gat.bow_forward_spreader: {RNGInit:true} run function gat.bow_forward_spreader:core/random/init
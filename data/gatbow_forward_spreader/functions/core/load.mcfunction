#> gatbow_forward_spreader:core/load
#
# 初期化処理
#
...
# init random number generator
    execute unless data storage gatbow_forward_spreader: {RNGInit:true} run function gatbow_forward_spreader:core/random/init
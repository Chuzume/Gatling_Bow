...
# 置き換え
    ...
    execute if data storage chuz:context Item.tag.Enchantments[{id:"minecraft:infinity"}] run data modify storage chuz:context Item.tag.ChuzData.Ammo set value "INFINITY"
